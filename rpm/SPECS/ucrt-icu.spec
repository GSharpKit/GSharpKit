...
# Win64
%package -n ucrt64-icu
Summary:        MinGW compilation of International Components for Unicode Tools

%description -n ucrt64-icu
ICU is a set of C and C++ libraries that provides robust and
full-featured Unicode and locale support. The library provides calendar
support, conversions for many character sets, language sensitive
collation, date and time formatting, support for many locales, message
...
%{ucrt64_bindir}/escapesrc.exe
%{ucrt64_bindir}/genrb.exe
%{ucrt64_bindir}/gencnval.exe
%{ucrt64_bindir}/uconv.exe
%{ucrt64_bindir}/gencmn.exe
%{ucrt64_bindir}/makeconv.exe
%{ucrt64_bindir}/genbrk.exe
%{ucrt64_bindir}/gensprep.exe
%{ucrt64_bindir}/pkgdata.exe
%{ucrt64_bindir}/icuexportdata.exe
%{ucrt64_bindir}/icupkg.exe
%{ucrt64_bindir}/derb.exe
%{ucrt64_bindir}/genccode.exe
%{ucrt64_bindir}/gendict.exe
%{ucrt64_bindir}/gencfu.exe
%{ucrt64_bindir}/gennorm2.exe
%{ucrt64_bindir}/icuinfo.exe
