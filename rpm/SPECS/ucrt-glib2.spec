...
# http://lists.fedoraproject.org/pipermail/ucrt/2013-March/006429.html
# http://lists.fedoraproject.org/pipermail/ucrt/2013-March/006469.html
...
# Win64
%package -n ucrt64-glib2
Summary:        MinGW Windows Glib2 library for the win64 target
# glib-genmarshal and glib-mkenums are written in Python
Requires:       python3

%description -n ucrt64-glib2
MinGW Windows Glib2 library.

%package -n ucrt64-glib2-static
Summary:        Static version of the MinGW Windows GLib2 library
Requires:       ucrt64-glib2 = %{version}-%{release}
Requires:       ucrt64-gettext-static

%description -n ucrt64-glib2-static
...
mkdir static
pushd static
%ucrt64_meson --default-library=static
ninja
popd
mkdir shared
pushd shared
%ucrt64_meson --default-library=shared
ninja
popd
...
#
#diff -ur shared/usr/i686-pc-ucrt32/sys-root/ucrt/lib/glib-2.0/include/glibconfig.h static/usr/i686-pc-ucrt32/sys-root/ucrt/lib/glib-2.0/include/glibconfig.h
#--- shared/usr/i686-pc-ucrt32/sys-root/ucrt/lib/glib-2.0/include/glibconfig.h	2009-02-20 17:34:35.735677022 +0100
#+++ static/usr/i686-pc-ucrt32/sys-root/ucrt/lib/glib-2.0/include/glibconfig.h	2009-02-20 17:33:35.498932269 +0100
#@@ -92,7 +92,8 @@
# 
# #define G_OS_WIN32
...
rm -f %{buildroot}%{ucrt64_bindir}/gdbus-codegen
rm -rf %{buildroot}%{ucrt64_libdir}/gdbus-2.0
sed -i 's|gdbus_codegen=.*|gdbus_codegen=%{_bindir}/gdbus-codegen|g' %{buildroot}%{ucrt64_libdir}/pkgconfig/gio-2.0.pc
...
# compilation.
%py_byte_compile %{__python3} %{buildroot}%{ucrt64_datadir}/glib-2.0/gdb
%py_byte_compile %{__python3} %{buildroot}%{ucrt64_datadir}/glib-2.0/codegen


# Win64
%files -n ucrt64-glib2
%license LICENSES/LGPL-2.1-or-later.txt
%{ucrt64_bindir}/gdbus.exe
%{ucrt64_bindir}/gi-compile-repository.exe
%{ucrt64_bindir}/gi-decompile-typelib.exe
%{ucrt64_bindir}/gi-inspect-typelib.exe
%{ucrt64_bindir}/gio.exe
%{ucrt64_bindir}/gio-querymodules.exe
%{ucrt64_bindir}/glib-compile-resources.exe
%{ucrt64_bindir}/glib-compile-schemas.exe
%{ucrt64_bindir}/glib-genmarshal
%{ucrt64_bindir}/glib-gettextize
%{ucrt64_bindir}/glib-mkenums
%{ucrt64_bindir}/gobject-query.exe
%{ucrt64_bindir}/gresource.exe
%{ucrt64_bindir}/gsettings.exe
%{ucrt64_bindir}/gspawn-win64-helper-console.exe
%{ucrt64_bindir}/gspawn-win64-helper.exe
%{ucrt64_bindir}/gtester-report
%{ucrt64_bindir}/libgio-2.0-0.dll
%{ucrt64_bindir}/libglib-2.0-0.dll
%{ucrt64_bindir}/libgmodule-2.0-0.dll
%{ucrt64_bindir}/libgobject-2.0-0.dll
%{ucrt64_bindir}/libgirepository-2.0-0.dll
%{ucrt64_bindir}/libgthread-2.0-0.dll
%{ucrt64_includedir}/glib-2.0/
%{ucrt64_includedir}/gio-win32-2.0/
%{ucrt64_libdir}/glib-2.0/
%{ucrt64_libdir}/libgio-2.0.dll.a
%{ucrt64_libdir}/libglib-2.0.dll.a
%{ucrt64_libdir}/libgmodule-2.0.dll.a
%{ucrt64_libdir}/libgobject-2.0.dll.a
%{ucrt64_libdir}/libgirepository-2.0.dll.a
%{ucrt64_libdir}/libgthread-2.0.dll.a
%{ucrt64_libdir}/pkgconfig/gio-2.0.pc
%{ucrt64_libdir}/pkgconfig/gio-windows-2.0.pc
%{ucrt64_libdir}/pkgconfig/girepository-2.0.pc
%{ucrt64_libdir}/pkgconfig/glib-2.0.pc
%{ucrt64_libdir}/pkgconfig/gmodule-2.0.pc
%{ucrt64_libdir}/pkgconfig/gmodule-export-2.0.pc
%{ucrt64_libdir}/pkgconfig/gmodule-no-export-2.0.pc
%{ucrt64_libdir}/pkgconfig/gobject-2.0.pc
%{ucrt64_libdir}/pkgconfig/gthread-2.0.pc
%{ucrt64_datadir}/aclocal/glib-2.0.m4
%{ucrt64_datadir}/aclocal/glib-gettext.m4
%{ucrt64_datadir}/aclocal/gsettings.m4
%{ucrt64_datadir}/gettext/its/
%{ucrt64_datadir}/glib-2.0/
%{ucrt64_datadir}/locale

%files -n ucrt64-glib2-static
%{ucrt64_libdir}/libgio-2.0.a
%{ucrt64_libdir}/libgirepository-2.0.a
%{ucrt64_libdir}/libglib-2.0.a
%{ucrt64_libdir}/libgmodule-2.0.a
%{ucrt64_libdir}/libgobject-2.0.a
%{ucrt64_libdir}/libgthread-2.0.a
...
- Update to 2.35.9
- Added R: ucrt{32,64}-gettext-static to the -static subpackages
- Prefer the use of GCC constructors over DllMain
...
- Update to 2.31.20
- Dropped unneeded BR: ucrt32-dlfcn
- Dropped .la files

* Tue Mar 06 2012 Erik van Pienbroek <epienbro@fedoraproject.org> - 2.31.18-2
- Renamed the source package to ucrt-glib2 (RHBZ #800389)
...
- Own the folders %%{_ucrt32_libdir}/gio and %%{_ucrt32_libdir}/gio/modules
...
- Dropped the ugly build hack as it isn't needed anymore (the
  broken ucrt32-runtime has been fixed by now)
...
- Fix a build failure in ucrt32-libsoup and ucrt32-webkitgtk
...
- Update to 2.21.1
- Use %%global instead of %%define
- Dropped the glib-i386-atomic.patch as it doesn't have any effect (the ucrt32
  toolchain is called i686-pc-ucrt32, not i386-pc-ucrt32)
...
- Rebuild for ucrt32-gcc 4.4 (RWMJ)
