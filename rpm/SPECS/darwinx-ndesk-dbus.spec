...
rm -f $RPM_BUILD_ROOT%{_darwinx_libdir}/mono/gac/NDesk.DBus/*/*.dll.config
...
%files
%defattr(-,root,root,-)
%{_darwinx_libdir}/mono/ndesk-dbus-1.0/
%{_darwinx_libdir}/mono/gac/NDesk.DBus/
%{_darwinx_libdir}/pkgconfig/ndesk-dbus-1.0.pc
