...
gacutil -i OpenMedicus.ServiceStack.EHR.ServiceModel.%{version}/lib/net461/OpenMedicus.ServiceStack.EHR.ServiceModel.dll -package %{darwinx_pkg_name} -root $RPM_BUILD_ROOT%{_darwinx_prefix}%{libdir} -gacdir mono/gac
...
%{_darwinx_prefix}%{libdir}/mono/%{darwinx_pkg_name}/OpenMedicus.ServiceStack.EHR.ServiceModel.dll
