...
# Win64
%package  -n ucrt64-gstreamer1
Summary:        MinGW Windows Streaming-Media Framework Runtime

%description -n ucrt64-gstreamer1
GStreamer is a streaming-media framework, based on graphs of filters
which operate on media data. Applications using this library can do
anything from real-time sound processing to playing videos, and just
about anything else media-related. Its plug-in-based architecture
...
rm -rf %{buildroot}%{ucrt64_datadir}/gstreamer-1.0/gdb
rm -rf %{buildroot}%{ucrt64_datadir}/gdb
rmdir %{buildroot}%{ucrt64_datadir}/gstreamer-1.0/

# Don't ship man pages
rm -rf %{buildroot}%{ucrt64_mandir}

# Win64
%files -n ucrt64-gstreamer1
%license COPYING

%dir %{ucrt64_includedir}/gstreamer-%{api_version}
%{ucrt64_includedir}/gstreamer-%{api_version}/gst

%dir %{ucrt64_libexecdir}/gstreamer-%{api_version}
%{ucrt64_libexecdir}/gstreamer-%{api_version}/gst-completion-helper.exe
%{ucrt64_libexecdir}/gstreamer-%{api_version}/gst-plugin-scanner.exe
%{ucrt64_libexecdir}/gstreamer-%{api_version}/gst-ptp-helper.exe

%dir %{ucrt64_libdir}/gstreamer-%{api_version}/
%{ucrt64_libdir}/gstreamer-%{api_version}/*.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/*.dll.a
%{ucrt64_libdir}/libgstbase-%{api_version}.dll.a
%{ucrt64_libdir}/libgstcheck-%{api_version}.dll.a
%{ucrt64_libdir}/libgstcontroller-%{api_version}.dll.a
%{ucrt64_libdir}/libgstnet-%{api_version}.dll.a
%{ucrt64_libdir}/libgstreamer-%{api_version}.dll.a
%{ucrt64_libdir}/pkgconfig/gstreamer-%{api_version}.pc
%{ucrt64_libdir}/pkgconfig/gstreamer-base-%{api_version}.pc
%{ucrt64_libdir}/pkgconfig/gstreamer-check-%{api_version}.pc
%{ucrt64_libdir}/pkgconfig/gstreamer-controller-%{api_version}.pc
%{ucrt64_libdir}/pkgconfig/gstreamer-net-%{api_version}.pc

%{ucrt64_bindir}/gst-inspect-%{api_version}.exe
%{ucrt64_bindir}/gst-launch-%{api_version}.exe
%{ucrt64_bindir}/gst-stats-%{api_version}.exe
%{ucrt64_bindir}/gst-typefind-%{api_version}.exe

%{ucrt64_bindir}/libgstbase-%{api_version}-0.dll
%{ucrt64_bindir}/libgstcheck-%{api_version}-0.dll
%{ucrt64_bindir}/libgstcontroller-%{api_version}-0.dll
%{ucrt64_bindir}/libgstnet-%{api_version}-0.dll
%{ucrt64_bindir}/libgstreamer-%{api_version}-0.dll

%{ucrt64_datadir}/aclocal/gst-element-check-%{api_version}.m4
%{ucrt64_datadir}/cmake/FindGStreamer.cmake
...
- Drop _WIN32_WINNT define, ucrt-9.0 defaults to _WIN32_WINNT=0xA00
