...
%build
%darwinx_meson -Dgtk_doc=disabled
%darwinx_meson_build
...
%license COPYING
%doc README
%{_darwinx_bindir}/orcc
%{_darwinx_bindir}/orc-bugreport
%{_darwinx_libdir}/liborc-0.4.0.dylib
%{_darwinx_libdir}/liborc-0.4.dylib
%{_darwinx_libdir}/liborc-test-0.4.0.dylib
%{_darwinx_libdir}/liborc-test-0.4.dylib
%{_darwinx_libdir}/pkgconfig/orc-0.4.pc
%{_darwinx_libdir}/pkgconfig/orc-test-0.4.pc
%{_darwinx_includedir}/orc-0.4/
...
- Updated to 0.4.14
- Updated to newer ucrt instructions (with _darwinx support)
