...
%build
%ucrt64_configure
%ucrt64_make %{?_smp_mflags} CFLAGS="$CFLAGS -std=gnu89"
...
%install
# We can't use the %%ucrt_make_install macro here as
...
install -m 0755 libtermcap-0.dll $RPM_BUILD_ROOT%{ucrt64_bindir}
install -m 0755 libtermcap.dll.a $RPM_BUILD_ROOT%{ucrt64_libdir}
...
- Renamed the source package to ucrt-termcap (#801034)
