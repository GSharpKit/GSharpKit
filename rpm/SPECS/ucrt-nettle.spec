...
# Mingw64
%package -n ucrt64-nettle
Summary: MinGW package for nettle cryptographic library


%description -n ucrt64-nettle
Nettle is a cryptographic library that is designed to fit easily in
more or less any context: In crypto toolkits for object-oriented
languages (C++, Python, Pike, ...), in applications like LSH or GNUPG,
or even in kernel space.
...
%build
autoreconf -ifv
%ucrt64_configure --enable-shared --enable-fat \
...
rm -f $RPM_BUILD_ROOT%{ucrt64_libdir}/libnettle.a
rm -f $RPM_BUILD_ROOT%{ucrt64_libdir}/libhogweed.a
rm -rf $RPM_BUILD_ROOT%{ucrt64_infodir}/


# Win64
%files -n ucrt64-nettle
%doc README
%license COPYINGv2 COPYING.LESSERv3
%{ucrt64_bindir}/nettle-hash.exe
%{ucrt64_bindir}/nettle-lfib-stream.exe
%{ucrt64_bindir}/nettle-pbkdf2.exe
%{ucrt64_bindir}/pkcs1-conv.exe
%{ucrt64_bindir}/sexp-conv.exe
%{ucrt64_bindir}/libnettle-8.dll
%{ucrt64_bindir}/libhogweed-6.dll
%{ucrt64_libdir}/libnettle.dll.a
%{ucrt64_libdir}/libhogweed.dll.a
%{ucrt64_libdir}/pkgconfig/nettle.pc
%{ucrt64_libdir}/pkgconfig/hogweed.pc
%dir %{ucrt64_includedir}/nettle
%{ucrt64_includedir}/nettle/*.h
