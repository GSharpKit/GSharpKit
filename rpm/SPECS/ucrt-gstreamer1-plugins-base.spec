...
Name:           ucrt-gstreamer1-plugins-base
Version:        1.28.6
Release:        1%{?dist}
...
BuildRequires:  ucrt64-libogg >= 1.0
BuildRequires:  ucrt64-libvorbis >= 1.0
BuildRequires:  ucrt64-libtheora
...
rm -rf %{buildroot}%{ucrt64_includedir}/GL
rm -rf %{buildroot}%{ucrt64_includedir}/KHR

# Win64
%files -n ucrt64-gstreamer1-plugins-base
%license COPYING
%doc README.md

%{ucrt64_bindir}/gst-device-monitor-%{api_version}.exe
%{ucrt64_bindir}/gst-play-%{api_version}.exe
%{ucrt64_bindir}/gst-discoverer-%{api_version}.exe
%{ucrt64_bindir}/libgstallocators-%{api_version}-0.dll
%{ucrt64_bindir}/libgstapp-%{api_version}-0.dll
%{ucrt64_bindir}/libgstaudio-%{api_version}-0.dll
%{ucrt64_bindir}/libgstfft-%{api_version}-0.dll
%{ucrt64_bindir}/libgstgl-%{api_version}-0.dll
%{ucrt64_bindir}/libgstpbutils-%{api_version}-0.dll
%{ucrt64_bindir}/libgstriff-%{api_version}-0.dll
%{ucrt64_bindir}/libgstrtp-%{api_version}-0.dll
%{ucrt64_bindir}/libgstrtsp-%{api_version}-0.dll
%{ucrt64_bindir}/libgstsdp-%{api_version}-0.dll
%{ucrt64_bindir}/libgsttag-%{api_version}-0.dll
%{ucrt64_bindir}/libgstvideo-%{api_version}-0.dll

%{ucrt64_includedir}/gstreamer-%{api_version}/

%{ucrt64_libdir}/gstreamer-%{api_version}/*.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/include
%{ucrt64_libdir}/libgstallocators-%{api_version}.dll.a
%{ucrt64_libdir}/libgstapp-%{api_version}.dll.a
%{ucrt64_libdir}/libgstaudio-%{api_version}.dll.a
%{ucrt64_libdir}/libgstfft-%{api_version}.dll.a
%{ucrt64_libdir}/libgstgl-%{api_version}.dll.a
%{ucrt64_libdir}/libgstpbutils-%{api_version}.dll.a
%{ucrt64_libdir}/libgstriff-%{api_version}.dll.a
%{ucrt64_libdir}/libgstrtp-%{api_version}.dll.a
%{ucrt64_libdir}/libgstrtsp-%{api_version}.dll.a
%{ucrt64_libdir}/libgstsdp-%{api_version}.dll.a
%{ucrt64_libdir}/libgsttag-%{api_version}.dll.a
%{ucrt64_libdir}/libgstvideo-%{api_version}.dll.a

%{ucrt64_libdir}/pkgconfig/*.pc

%{ucrt64_datadir}/gst-plugins-base
...
- Update to 1.2.4
- Fix FTBFS against ucrt-gcc 4.9
