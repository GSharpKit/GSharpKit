...
%package -n mingw32-gdl
Summary:        MinGW Windows GTK+ library
Requires:       pkgconfig

%description -n mingw32-gdl
...
%package -n mingw64-gdl
Summary:        MinGW Windows GTK+ library
Requires:       pkgconfig

%description -n mingw64-gdl
GDL adds dockable widgets to GTK+. The user can rearrange those widgets by drag
and drop and layouts can be saved and loaded. Currently it is used by anjuta,
inkscape, gtranslator and others.
...
%files -n mingw32-gdl -f mingw32-%{name}.lang
%doc COPYING
...
%files -n mingw64-gdl -f mingw64-%{name}.lang
%doc COPYING
