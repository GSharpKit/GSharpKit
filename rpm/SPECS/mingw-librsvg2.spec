...
%mingw_meson -Dpixbuf-loader=enabled
%mingw_ninja
...
%{mingw32_libdir}/gdk-pixbuf-2.0/2.10.0/loaders/pixbufloader_svg.dll
...
%{mingw64_libdir}/gdk-pixbuf-2.0/2.10.0/loaders/pixbufloader_svg.dll
