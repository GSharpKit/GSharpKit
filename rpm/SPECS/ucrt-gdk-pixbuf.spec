...
# wine /usr/i686-w64-ucrt32/sys-root/ucrt/bin/gdk-pixbuf-query-loaders.exe | sed s@'Z:/usr/i686-w64-ucrt32/sys-root/ucrt'@'..'@ > gdk-pixbuf.loaders
...
%package -n ucrt64-gdk-pixbuf
Summary:        MinGW Windows GDK Pixbuf library

%description -n ucrt64-gdk-pixbuf
MinGW Windows GDK Pixbuf library.
...
install -m 0644 %{SOURCE1} gdk-pixbuf/loaders.cache
...
rm -f %{buildroot}%{ucrt64_libdir}/gdk-pixbuf-2.0/2.10.0/loaders/*.dll.a

# Install the loaders.cache file
install -m 0644 %{SOURCE1} %{buildroot}%{ucrt64_libdir}/gdk-pixbuf-2.0/2.10.0/loaders.cache

%files -n ucrt64-gdk-pixbuf
%license COPYING
%{ucrt64_bindir}/gdk-pixbuf-csource.exe
%{ucrt64_bindir}/gdk-pixbuf-pixdata.exe
%{ucrt64_bindir}/gdk-pixbuf-query-loaders.exe
%{ucrt64_bindir}/libgdk_pixbuf-2.0-0.dll
%dir %{ucrt64_libdir}/gdk-pixbuf-2.0
%dir %{ucrt64_libdir}/gdk-pixbuf-2.0/2.10.0
%dir %{ucrt64_libdir}/gdk-pixbuf-2.0/2.10.0/loaders
%{ucrt64_libdir}/gdk-pixbuf-2.0/2.10.0/loaders.cache
%{ucrt64_libdir}/gdk-pixbuf-2.0/2.10.0/loaders/libpixbufloader-ani.dll
%{ucrt64_libdir}/gdk-pixbuf-2.0/2.10.0/loaders/libpixbufloader-icns.dll
%{ucrt64_libdir}/gdk-pixbuf-2.0/2.10.0/loaders/libpixbufloader-pnm.dll
%{ucrt64_libdir}/gdk-pixbuf-2.0/2.10.0/loaders/libpixbufloader-qtif.dll
%{ucrt64_libdir}/gdk-pixbuf-2.0/2.10.0/loaders/libpixbufloader-tga.dll
%{ucrt64_libdir}/gdk-pixbuf-2.0/2.10.0/loaders/libpixbufloader-xbm.dll
%{ucrt64_libdir}/gdk-pixbuf-2.0/2.10.0/loaders/libpixbufloader-xpm.dll
%{ucrt64_libdir}/libgdk_pixbuf-2.0.dll.a
%{ucrt64_libdir}/pkgconfig/gdk-pixbuf-2.0.pc
%{ucrt64_includedir}/gdk-pixbuf-2.0/
...
- Rebuilt for ucrt-jasper update
...
- Renamed the source package to ucrt-gdk-pixbuf (RHBZ #800383)
...
- Bump the BR: ucrt32-filesystem to >= 61 because of ucrt32(gdiplus.dll) provides
...
- Fixed a bug which caused the path /usr/i686-pc-ucrt32/sys-root/ucrt to get hardcoded
  in the resulting library resulting in runtime failures on Win32 environments
- Moved the file %%{_ucrt32_sysconfdir}/gtk-2.0/gdk-pixbuf.loaders to
  %%{_ucrt32_libdir}/gdk-pixbuf-2.0/2.10.0/loaders.cache

* Sun Sep 12 2010 Erik van Pienbroek <epienbro@fedoraproject.org> - 2.21.7-1
- Initial release (split off from the ucrt32-gtk2 package)
