...
#BuildRequires:  ucrt64-angleproject
...
%package -n ucrt64-libepoxy
Summary:        MinGW Windows libepoxy library
#Requires:       ucrt64-angleproject

%description -n ucrt64-libepoxy
Epoxy is a library for handling OpenGL function pointer management.
...
%files -n ucrt64-libepoxy
%license COPYING
%{ucrt64_bindir}/libepoxy-0.dll
%{ucrt64_libdir}/libepoxy.dll.a
%{ucrt64_libdir}/pkgconfig/epoxy.pc
%{ucrt64_includedir}/epoxy/
...
- Add missing runtime requires on ucrt-angleproject
...
- Don't explicitly BR ucrt{32,64}-binutils
- Fix the license tag
