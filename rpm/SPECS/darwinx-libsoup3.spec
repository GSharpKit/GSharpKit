...
Source0:	http://download.gnome.org/sources/libsoup/3.4/libsoup-%{version}.tar.xz
...
%files 
%defattr(-,root,wheel,-)
%{_darwinx_includedir}/libsoup-3.0/
%{_darwinx_libdir}/libsoup-3.0.0.dylib
%{_darwinx_libdir}/libsoup-3.0.dylib
