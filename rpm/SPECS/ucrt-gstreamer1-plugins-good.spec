...
Name:           ucrt-gstreamer1-plugins-good
Version:        1.28.6
Release:        1%{?dist}
...
#BuildRequires:  ucrt64-libsoup3
BuildRequires:  ucrt64-wavpack
BuildRequires:  ucrt64-speex
BuildRequires:  ucrt64-taglib
...
# Mingw64
%package -n ucrt64-gstreamer1-plugins-good
Summary:        %{summary}
Requires:       ucrt64-gstreamer1 >= %{version}
Requires:       ucrt64-gstreamer1-plugins-base >= %{version}

%description -n ucrt64-gstreamer1-plugins-good
GStreamer is a streaming media framework, based on graphs of filters which
operate on media data. Applications using this library can do anything
from real-time sound processing to playing videos, and just about anything
else media-related.  Its plugin-based architecture means that new data
...
rm -rf %{buildroot}%{ucrt64_libdir}/gstreamer-%{api_version}/*.dll.a



# Mingw64
%files -n ucrt64-gstreamer1-plugins-good
%license COPYING
%doc README.md
...
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstalaw.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstalpha.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstalphacolor.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstapetag.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstaudiofx.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstaudioparsers.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstauparse.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstautodetect.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstavi.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstcutter.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstdebug.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstdeinterlace.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstdtmf.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgsteffectv.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstequalizer.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstflv.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstflxdec.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstgoom.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstgoom2k1.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgsticydemux.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstid3demux.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstimagefreeze.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstinterleave.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstisomp4.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstlevel.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstmatroska.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstmulaw.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstmultifile.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstmultipart.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstnavigationtest.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstreplaygain.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstrtp.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstrtpmanager.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstrtsp.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstshapewipe.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstsmpte.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstspectrum.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstspeex.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgsttaglib.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstudp.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstvideobox.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstvideocrop.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstvideofilter.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstvideomixer.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstwaveform.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstwavenc.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstwavpack.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstwavparse.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgsty4m.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstxingmux.dll

# gstreamer1-plugins with external dependencies but in the main package
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstcairo.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstdirectsound.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstgdkpixbuf.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstjpeg.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstpng.dll
%{ucrt64_libdir}/gstreamer-%{api_version}/libgstgtk.dll
