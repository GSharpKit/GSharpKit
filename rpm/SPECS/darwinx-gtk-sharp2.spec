...
%{__rm} -rf $RPM_BUILD_ROOT%{_darwinx_libdir}/gtk-sharp-2.0/
%{__rm} -rf $RPM_BUILD_ROOT%{_darwinx_bindir}/gapi2-codegen
%{__rm} -rf $RPM_BUILD_ROOT%{_darwinx_bindir}/gapi2-fixup
%{__rm} -rf $RPM_BUILD_ROOT%{_darwinx_bindir}/gapi2-parser
%{__rm} -rf $RPM_BUILD_ROOT%{_darwinx_libdir}/pkgconfig/gapi-2.0.pc
%{__rm} -rf $RPM_BUILD_ROOT%{_darwinx_datadir}/gapi-2.0
...
%files
%defattr(-,root,root,-)
%{_darwinx_libdir}/libatksharpglue-2.so
%{_darwinx_libdir}/libgtksharpglue-2.so
%{_darwinx_libdir}/libpangosharpglue-2.so
%{_darwinx_libdir}/libgdksharpglue-2.so
%{_darwinx_libdir}/libglibsharpglue-2.so
%{_darwinx_libdir}/libgladesharpglue-2.so
%{_darwinx_libdir}/mono/gac
%{_darwinx_libdir}/mono/gtk-sharp-2.0
%{_darwinx_libdir}/pkgconfig/glib-sharp-2.0.pc
%{_darwinx_libdir}/pkgconfig/gtk-sharp-2.0.pc
%{_darwinx_libdir}/pkgconfig/gtk-dotnet-2.0.pc
%{_darwinx_libdir}/pkgconfig/glade-sharp-2.0.pc
%{_darwinx_libdir}/libatksharpglue-2.la
%{_darwinx_libdir}/libgtksharpglue-2.la
%{_darwinx_libdir}/libpangosharpglue-2.la
%{_darwinx_libdir}/libglibsharpglue-2.la
%{_darwinx_libdir}/libgdksharpglue-2.la
%{_darwinx_libdir}/libgladesharpglue-2.la
