...
Patch2:	       ucrt-enchant-cast.patch
...
# Win64
%package -n ucrt64-enchant
Summary:       MinGW Windows Enchanting Spell Checking Library
Requires:      pkgconfig

%description -n ucrt64-enchant
A library that wraps other spell checking backends.

This is the MinGW build of enchant

%package -n ucrt64-enchant-static
Summary:       Static version of the MinGW Windows enchant library
Requires:      ucrt64-enchant = %{version}-%{release}

%description -n ucrt64-enchant-static
...
# Win64
%files -n ucrt64-enchant
%doc AUTHORS COPYING.LIB README
%{ucrt64_bindir}/enchant-lsmod.exe
%{ucrt64_bindir}/enchant.exe
%{ucrt64_bindir}/libenchant.dll
%{ucrt64_includedir}/enchant/
%dir %{ucrt64_libdir}/enchant/
%{ucrt64_libdir}/enchant/libenchant_myspell.dll
%{ucrt64_libdir}/enchant/libenchant_myspell.dll.a
%{ucrt64_libdir}/libenchant.dll.a
%{ucrt64_libdir}/pkgconfig/enchant.pc
%{ucrt64_datadir}/enchant/

%files -n ucrt64-enchant-static
%{ucrt64_libdir}/libenchant.a
%{ucrt64_libdir}/enchant/libenchant_myspell.a
...
- Renamed the source package to ucrt-enchant (RHBZ #800863)
...
- Rebuild for updated ucrt32-hunspell
...
- Moved the file %%{_ucrt32_libdir}/enchant/libenchant_myspell.a to
