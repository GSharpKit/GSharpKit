...
# Win64
%package -n ucrt64-pango
Summary:        MinGW Windows Pango library
Requires:       pkgconfig

%description -n ucrt64-pango
MinGW Windows Pango library.

%package -n ucrt64-pango-static
Summary:        Static version of the MinGW Windows Pango library
Requires:       ucrt64-pango = %{version}-%{release}

%description -n ucrt64-pango-static
...
mkdir build_ucrt
pushd build_ucrt
%ucrt64_meson --default-library=both -Dintrospection=disabled -Dgtk_doc=false -Dfontconfig=enabled
ninja
popd
...
mkdir -p %{buildroot}%{ucrt64_sysconfdir}/pango/


# Win64
%files -n ucrt64-pango
%license COPYING
%{ucrt64_bindir}/libpango-1.0-0.dll
%{ucrt64_bindir}/libpangocairo-1.0-0.dll
%{ucrt64_bindir}/libpangoft2-1.0-0.dll
%{ucrt64_bindir}/libpangowin32-1.0-0.dll
%{ucrt64_bindir}/pango-list.exe
%{ucrt64_bindir}/pango-segmentation.exe
%{ucrt64_bindir}/pango-view.exe
%{ucrt64_includedir}/pango-1.0/
%{ucrt64_libdir}/libpango-1.0.dll.a
%{ucrt64_libdir}/libpangocairo-1.0.dll.a
%{ucrt64_libdir}/libpangoft2-1.0.dll.a
%{ucrt64_libdir}/libpangowin32-1.0.dll.a
%{ucrt64_libdir}/pkgconfig/pango.pc
%{ucrt64_libdir}/pkgconfig/pangocairo.pc
%{ucrt64_libdir}/pkgconfig/pangofc.pc
%{ucrt64_libdir}/pkgconfig/pangoft2.pc
%{ucrt64_libdir}/pkgconfig/pangoot.pc
%{ucrt64_libdir}/pkgconfig/pangowin32.pc
%{ucrt64_sysconfdir}/pango/

%files -n ucrt64-pango-static
%{ucrt64_libdir}/libpango-1.0.a
%{ucrt64_libdir}/libpangocairo-1.0.a
%{ucrt64_libdir}/libpangoft2-1.0.a
%{ucrt64_libdir}/libpangowin32-1.0.a
...
- Update to 1.31.0
- Added BR: ucrt32-harfbuzz/ucrt64-harfbuzz
...
- Renamed the source package to ucrt-pango (#800444)
...
- Added some (already upstreamed) patches to get pango compiled on ucrt32

* Thu Aug 13 2009 Erik van Pienbroek <epienbro@fedoraproject.org> - 1.25.2-1
- Update to 1.25.2
- Added BR: ucrt32-gcc-c++
