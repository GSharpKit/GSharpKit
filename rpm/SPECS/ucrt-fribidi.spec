...
mkdir build_ucrt
pushd build_ucrt
%ucrt64_meson --default-library=both -Ddocs=false
ninja
popd
...
%license COPYING
%{ucrt64_bindir}/fribidi.exe
%{ucrt64_bindir}/libfribidi-0.dll
%{ucrt64_includedir}/fribidi
%{ucrt64_libdir}/libfribidi.dll.a
%{ucrt64_libdir}/pkgconfig/fribidi.pc

%files -n ucrt64-%{pkgname}-static
%{ucrt64_libdir}/libfribidi.a
