...
%global add_to_doc_files64() \
    mkdir -p %{buildroot}%{_docdir}/ucrt64-webkitgtk3 ||: ; \
    cp -p %1  %{buildroot}%{_docdir}/ucrt64-webkitgtk3/$(echo '%1' | sed -e 's!/!.!g')

Name:           ucrt-webkitgtk3
Version:        2.4.12
Release:        3%{?dist}
...
# Fix llint build with ucrt64, patch taken from
# https://github.com/Alexpux/MINGW-packages/blob/master/ucrt-w64-webkitgtk3/0101-webkitgtk-2.4.3-gcc-asm.all.patch
...
Patch16:	webkitgtk-extern.patch
...
#BuildRequires:  ucrt64-enchant
BuildRequires:  ucrt64-filesystem >= 95
BuildRequires:  ucrt64-fontconfig
BuildRequires:  ucrt64-freetype
BuildRequires:  ucrt64-gcc
BuildRequires:  ucrt64-gcc-c++
BuildRequires:  ucrt64-gstreamer1
BuildRequires:  ucrt64-gstreamer1-plugins-base
BuildRequires:  ucrt64-gtk3
BuildRequires:  ucrt64-libidn
BuildRequires:  ucrt64-libsoup
BuildRequires:  ucrt64-libwebp
BuildRequires:  ucrt64-libxml2
BuildRequires:  ucrt64-libxslt
BuildRequires:  ucrt64-winpthreads
BuildRequires:  ucrt64-sqlite
BuildRequires:	ucrt64-icu74 ucrt64-icu74-devel
...
%package -n ucrt64-webkitgtk3
Summary:        MinGW Windows web content engine library

%description -n ucrt64-webkitgtk3
WebKitGTK+ is an open-source Web content engine library.
This package contains the shared libraries for the WebKit GTK+ port
as well as the sample GtkLauncher tool.
...
install -m 755 Programs/.libs/GtkLauncher.exe %{buildroot}%{ucrt64_bindir}/GtkLauncher-3.exe
...
%files -n ucrt64-webkitgtk3
%{_docdir}/ucrt64-webkitgtk3/
%{ucrt64_bindir}/jsc-3.exe
%{ucrt64_bindir}/GtkLauncher-3.exe
%{ucrt64_bindir}/libjavascriptcoregtk-3.0-0.dll
%{ucrt64_bindir}/libwebkitgtk-3.0-0.dll
%{ucrt64_includedir}/webkitgtk-3.0/
%{ucrt64_libdir}/libjavascriptcoregtk-3.0.dll.a
%{ucrt64_libdir}/libwebkitgtk-3.0.dll.a
%{ucrt64_libdir}/pkgconfig/javascriptcoregtk-3.0.pc
%{ucrt64_libdir}/pkgconfig/webkitgtk-3.0.pc
%{ucrt64_datadir}/webkitgtk-3.0/
...
- Fix the build with GCC 6
- Re-enable ucrt64 build and add a patch to make it build again,
...
- Rebuild against ucrt-libwebp-0.5.0

* Mon Aug 31 2015 Kalev Lember <klember@redhat.com> - 2.4.9-1
- Update to 2.4.9
- Temporarily disable the ucrt64 build
...
- Fix FTBFS caused by the changed pkg-config behavior in ucrt-filesystem
...
- Initial ucrt-webkitgtk3 packaging, based on Fedora ucrt-webkitgtk
