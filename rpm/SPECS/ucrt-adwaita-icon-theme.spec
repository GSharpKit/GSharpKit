...
%package -n ucrt64-adwaita-icon-theme
Summary:        MinGW Adwaita icon theme for MingGW
Requires:       pkgconfig

%description -n ucrt64-adwaita-icon-theme
...
%files -n ucrt64-adwaita-icon-theme
%license %{ucrt64_datadir}/licenses/adwaita-icon-theme/COPYING
%license %{ucrt64_datadir}/licenses/adwaita-icon-theme/COPYING_CCBYSA3
%license %{ucrt64_datadir}/licenses/adwaita-icon-theme/COPYING_LGPL
%{ucrt64_datadir}/pkgconfig/adwaita-icon-theme.pc
%dir %{ucrt64_datadir}/icons/Adwaita
%{ucrt64_datadir}/icons/Adwaita/16x16
%{ucrt64_datadir}/icons/Adwaita/cursors
%{ucrt64_datadir}/icons/Adwaita/scalable
%{ucrt64_datadir}/icons/Adwaita/index.theme
%{ucrt64_datadir}/icons/Adwaita/symbolic
%ghost %{ucrt64_datadir}/icons/Adwaita/icon-theme.cache
...
- Don't use obsolete ucrt_make_install macro
