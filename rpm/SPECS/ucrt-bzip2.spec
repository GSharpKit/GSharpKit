...
# (like ucrt.org and gnuwin32) and it resolves various autoconf and
...
Summary:        Static library for ucrt64-bzip2 development
...
for dir in $RPM_BUILD_ROOT%{ucrt64_bindir} ; do
pushd $dir
...
- Renamed the source package to ucrt-bzip2 (RHBZ #800847)
