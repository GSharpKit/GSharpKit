...
Version: %{version}
Libs: -r:${libdir}/Side.dll -r:${libdir}/Digst.OioIdws.Common.dll -r:${libdir}/Digst.OioIdws.OioWsTrust.dll -r:${libdir}/Digst.OioIdws.Rest.Common.dll -r:${libdir}/Digst.OioIdws.Rest.Client.dll
Cflags:
EOF
