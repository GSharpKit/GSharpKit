...
#BuildRequires:  ucrt64-brotli
BuildRequires:  ucrt64-libpsl
BuildRequires:  ucrt64-sqlite
BuildRequires:  ucrt64-glib-networking
...
# Win64
%package -n ucrt64-libsoup
Summary:        MinGW library for HTTP and XML-RPC functionality
Requires:       pkgconfig
Requires:       ucrt64-glib-networking
# Dropped in F25
Obsoletes:      ucrt64-libsoup-static < 2.54.1

%description -n ucrt64-libsoup
Libsoup is an HTTP library implementation in C. It was originally part
of a SOAP (Simple Object Access Protocol) implementation called Soup, but
the SOAP and non-SOAP parts have now been split into separate packages.
...
# Win64
%files -n ucrt64-libsoup
%license COPYING
%{ucrt64_bindir}/libsoup-2.4-1.dll
%{ucrt64_bindir}/libsoup-gnome-2.4-1.dll
%{ucrt64_includedir}/libsoup-2.4
%{ucrt64_includedir}/libsoup-gnome-2.4
%{ucrt64_libdir}/libsoup-2.4.dll.a
%{ucrt64_libdir}/libsoup-gnome-2.4.dll.a
%{ucrt64_libdir}/pkgconfig/libsoup-2.4.pc
%{ucrt64_libdir}/pkgconfig/libsoup-gnome-2.4.pc
...
- Add ucrt-glib-networking as dep (#1169185)
...
- Renamed the source package to ucrt-libsoup (#800433)
...
- Dropped the BR: ucrt32-gnutls as support for TLS connections has
...
- Added BR: ucrt32-gnutls for SSL support
