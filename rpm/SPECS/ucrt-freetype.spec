...
- Update to 2.5.0.1
- Added BR: ucrt32-libpng ucrt64-libpng
...
- Update to 2.4.9
- Added BR: ucrt32-bzip2 ucrt64-bzip2
...
- Renamed the source package to ucrt-freetype (RHBZ #800380)
...
- Spec cleanup
- Enable automatic ucrt dep extraction
...
- Use _smp_mflags.
- BR ucrt32-dlfcn (not required, but uses it if installed).
