...
install -m 644 OpenMedicus.ServiceStack.Master.ServiceModel.%{version}/lib/net461/OpenMedicus.ServiceStack.Master.ServiceModel.dll $RPM_BUILD_ROOT%{mingw32_prefix}%{libdir}
...
install -m 644 OpenMedicus.ServiceStack.Master.ServiceModel.%{version}/lib/net461/OpenMedicus.ServiceStack.Master.ServiceModel.dll $RPM_BUILD_ROOT%{mingw64_prefix}%{libdir}
...
%defattr(-,root,root,-)
%{mingw32_prefix}%{libdir}/OpenMedicus.ServiceStack.Master.ServiceModel.dll
%{mingw32_datadir}/pkgconfig/OpenMedicus.ServiceStack.Master.ServiceModel.pc

%files -n mingw64-%{mingw_pkg_name}
%defattr(-,root,root,-)
%{mingw64_prefix}%{libdir}/OpenMedicus.ServiceStack.Master.ServiceModel.dll
