...
# Win64
%package -n ucrt64-libffi
Summary:	A portable foreign function interface library for MinGW

%description -n ucrt64-libffi
Foreign function interface library for MinGW.

# Win64 static
%package -n ucrt64-libffi-static
Summary:       A portable foreign function interface static library for MinGW

%description -n ucrt64-libffi-static
...
%files -n ucrt64-libffi
%license LICENSE
%{ucrt64_bindir}/libffi-8.dll
%{ucrt64_includedir}/ffi.h
%{ucrt64_includedir}/ffitarget.h
%{ucrt64_libdir}/libffi.dll.a
%{ucrt64_libdir}/pkgconfig/libffi.pc

%files -n ucrt64-libffi-static
%{ucrt64_libdir}/libffi.a
...
- Rebuild against latest ucrt-filesystem
...
- Renamed the source package to ucrt-libffi (#800427)
- Spec clean up
