...
%build
%ucrt64_cmake -DDISABLE_LOCALE_CHARSET=ON
make

%install
make install DESTDIR=%{buildroot}

rm %{buildroot}/%{ucrt64_bindir}/win_iconv.exe

# Fix file conflict with ucrt-libcharset
rm -f %{buildroot}%{ucrt64_includedir}/localcharset.h
...
- Bumped the requirement for ucrt32-filesystem to >= 68 because of RPM 4.9 support
...
- Use the name ucrt-win-iconv for the srpm to ease the transition to
  the ucrt-w64 based toolchain
...
- Bumped the ucrt32-iconv obsoletes

* Thu Sep 30 2010 Erik van Pienbroek <epienbro@fedoraproject.org> - 0.0.1-1
- Initial release
- Obsoletes/provides ucrt32-iconv and ucrt32-iconv-static
