...
# Mingw64
%package -n ucrt64-gmp
Summary: Cross-compiled GNU arbitrary precision library


%description -n ucrt64-gmp
The gmp package contains GNU MP, a library for arbitrary precision
arithmetic, signed integers operations, rational numbers and floating
point numbers. GNU MP is designed for speed, for both small and very
large operands. GNU MP is fast because it uses fullwords as the basic
...
rm -f $RPM_BUILD_ROOT%{ucrt64_libdir}/lib{gmp,mp,gmpxx}.la

# Remove documentation which duplicates that found in the native package.
rm -r $RPM_BUILD_ROOT/%{ucrt64_prefix}/share
...
%doc NEWS README
%{ucrt64_bindir}/libgmp-10.dll
%{ucrt64_bindir}/libgmpxx-4.dll
%{ucrt64_libdir}/libgmp.dll.a
%{ucrt64_libdir}/libgmpxx.dll.a
%{ucrt64_libdir}/pkgconfig/gmp.pc
%{ucrt64_libdir}/pkgconfig/gmpxx.pc
%{ucrt64_includedir}/gmp.h
%{ucrt64_includedir}/gmpxx.h
