...
# Win64
%package -n ucrt64-cairo
Summary:        MinGW Windows Cairo library
Requires:       ucrt64-fontconfig
Requires:       ucrt64-freetype
Requires:       pkgconfig

%description -n ucrt64-cairo
MinGW Windows Cairo library.

%package -n ucrt64-cairo-static
Summary:        Static version of the MinGW Windows Cairo library
Requires:       ucrt64-cairo = %{version}-%{release}

%description -n ucrt64-cairo-static
...
mkdir build_ucrt
pushd build_ucrt
%ucrt64_meson --default-library both -Dfontconfig=enabled -Dfreetype=enabled
ninja
popd
...
# Win64
%files -n ucrt64-cairo
%license COPYING COPYING-LGPL-2.1 COPYING-MPL-1.1
%{ucrt64_bindir}/libcairo-2.dll
%{ucrt64_bindir}/libcairo-gobject-2.dll
%{ucrt64_bindir}/libcairo-script-interpreter-2.dll
%{ucrt64_includedir}/cairo/
%{ucrt64_libdir}/libcairo.dll.a
%{ucrt64_libdir}/libcairo-gobject.dll.a
%{ucrt64_libdir}/libcairo-script-interpreter.dll.a
%{ucrt64_libdir}/pkgconfig/cairo-gobject.pc
%{ucrt64_libdir}/pkgconfig/cairo-fc.pc
%{ucrt64_libdir}/pkgconfig/cairo.pc
%{ucrt64_libdir}/pkgconfig/cairo-pdf.pc
%{ucrt64_libdir}/pkgconfig/cairo-dwrite-font.pc
%{ucrt64_libdir}/pkgconfig/cairo-svg.pc
%{ucrt64_libdir}/pkgconfig/cairo-ps.pc
%{ucrt64_libdir}/pkgconfig/cairo-win32-font.pc
%{ucrt64_libdir}/pkgconfig/cairo-ft.pc
%{ucrt64_libdir}/pkgconfig/cairo-png.pc
%{ucrt64_libdir}/pkgconfig/cairo-script.pc
%{ucrt64_libdir}/pkgconfig/cairo-script-interpreter.pc
%{ucrt64_libdir}/pkgconfig/cairo-tee.pc
%{ucrt64_libdir}/pkgconfig/cairo-win32.pc

%files -n ucrt64-cairo-static
%{ucrt64_libdir}/libcairo.a
%{ucrt64_libdir}/libcairo-gobject.a
%{ucrt64_libdir}/libcairo-script-interpreter.a
...
- Renamed the source package to ucrt-cairo (RHBZ #800373)
...
- Update to 1.8.10
- Dropped BR: ucrt32-dlfcn as it's unneeded
...
- Remove BRs on ucrt32-fontconfig and ucrt32-freetype which are
  not needed on Win32.
- Use _smp_mflags.
- Added BRs ucrt32-dlfcn, ucrt32-iconv, ucrt32-zlib.
