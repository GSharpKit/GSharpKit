...
%package -n ucrt64-gtksourceview4
Summary:        Source code editing widget

%description -n ucrt64-gtksourceview4
GtkSourceView is a GNOME library that extends GtkTextView, the standard GTK+
widget for multiline text editing. GtkSourceView adds support for syntax
highlighting, undo/redo, file loading and saving, search and replace, a
completion system, printing, displaying line numbers, and other features
...
mkdir build_ucrt
pushd build_ucrt
%ucrt64_meson -Dgtk_doc=false -Dinstall_tests=false -Dgir=false -Dglade_catalog=false -Dvapi=false
ninja
popd
...
rm -f %{buildroot}%{ucrt64_libdir}/libgtksourceview-4.dll.a


%files -n ucrt64-gtksourceview4
%license COPYING
%{ucrt64_bindir}/libgtksourceview-4-0.dll
%{ucrt64_datadir}/gtksourceview-4/
%{ucrt64_libdir}/pkgconfig/*.pc
%dir %{ucrt64_includedir}/gtksourceview-4
%{ucrt64_includedir}/gtksourceview-4/*
