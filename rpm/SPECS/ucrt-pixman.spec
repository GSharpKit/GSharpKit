...
# Win64
%package -n ucrt64-pixman
Summary:        MinGW Windows Pixman library

%description -n ucrt64-pixman
MinGW Windows Pixman library.

%package -n ucrt64-pixman-static
Summary:        Static version of the cross compiled Pixman library
Requires:       ucrt64-pixman = %{version}-%{release}

%description -n ucrt64-pixman-static
...
%build
# Uses GTK for its testsuite, so disable this otherwise we have a chicken & egg problem on ucrt
mkdir ucrt_build
pushd ucrt_build
%ucrt64_meson --default-library=both -Dgtk=disabled -Dtests=disabled -Ddemos=disabled
ninja
popd
...
# Win64
%files -n ucrt64-pixman
%license COPYING
%{ucrt64_bindir}/libpixman-1-0.dll
%{ucrt64_includedir}/pixman-1
%{ucrt64_libdir}/libpixman-1.dll.a
%{ucrt64_libdir}/pkgconfig/pixman-1.pc

%files -n ucrt64-pixman-static
%{ucrt64_libdir}/libpixman-1.a
...
- Renamed the source package to ucrt-pixman (#800445)
