...
%ucrt64_configure --enable-static --enable-shared --enable-ld-version-script
...
- Renamed the source package to ucrt-libtiff (#800437)
- Spec clean up
...
- Rebuilt with ucrt32-libjpeg-turbo, dropped jpeg_boolean patch (#604702)
...
- add ucrt32-gcc-c++ to the BuildRequirements
...
- exported proper ucrt32 cflags
- removed make check
- removed executables
- removed multilib stuff (irrelevant for ucrt32)
- fixed defattr
- added .la files back in

* Sun Mar 22 2009 Michael Ploujnikov <ploujj@gmail.com> - 3.8.2-13
- Initial ucrt32 build
