...
BuildRequires:  ucrt64-libxml2 >= 2.7.2-3
...
# Win64
%package -n ucrt64-libxslt
Summary:        MinGW Windows Library providing the Gnome XSLT engine
Requires:       ucrt64-libxml2 >= 2.7.2-3
Requires:       pkgconfig

%description -n ucrt64-libxslt
This C library allows to transform XML files into other XML files
(or HTML, text, ...) using the standard XSLT stylesheet transformation
mechanism. To use it you need to have a version of libxml2 >= 2.6.27
installed. The xsltproc command is a command line interface to the XSLT engine

%package -n ucrt64-libxslt-static
Summary:        Static version of the MinGW Windows LibXSLT library
Requires:       ucrt64-libxslt = %{version}-%{release}

%description -n ucrt64-libxslt-static
...
%build
%ucrt64_configure --without-python --enable-shared --enable-static
%ucrt64_make
...
rm -r %{buildroot}%{ucrt64_datadir}/gtk-doc
...
# Win64
%files -n ucrt64-libxslt
%license Copyright
%{ucrt64_bindir}/xslt-config
%{ucrt64_bindir}/xsltproc.exe
%{ucrt64_includedir}/libexslt
%{ucrt64_includedir}/libxslt
%{ucrt64_bindir}/libexslt-0.dll
%{ucrt64_libdir}/libexslt.dll.a
%{ucrt64_bindir}/libxslt-1.dll
%{ucrt64_libdir}/libxslt.dll.a
%{ucrt64_libdir}/pkgconfig/libexslt.pc
%{ucrt64_libdir}/pkgconfig/libxslt.pc
%{ucrt64_libdir}/cmake/libxslt/
%{ucrt64_libdir}/xsltConf.sh

%files -n ucrt64-libxslt-static
%{ucrt64_libdir}/libexslt.a
%{ucrt64_libdir}/libxslt.a
...
- Renamed the source package to ucrt-libxslt (#800931)
...
- Fix compatibility with ucrt-w64
...
- Dropped upstreamed ucrt32 patches
