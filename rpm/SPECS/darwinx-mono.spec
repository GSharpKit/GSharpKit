...
%{_darwinx_prefix}/lib/mono/4.5/symbolicate.exe
%{_darwinx_prefix}/lib/mono/4.5/symbolicate.exe.mdb
...
%changelog
* Tue Mar 25 2014 Mikkel Kruse Johnsen <mikkel@structura-it.dk> - 3.2.8-1
- Initial version
