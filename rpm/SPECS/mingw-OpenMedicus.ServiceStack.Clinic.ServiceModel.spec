...
install -m 644 OpenMedicus.ServiceStack.Clinic.ServiceModel.%{version}/lib/net461/OpenMedicus.ServiceStack.Clinic.ServiceModel.dll $RPM_BUILD_ROOT%{mingw32_prefix}%{libdir}
...
install -m 644 OpenMedicus.ServiceStack.Clinic.ServiceModel.%{version}/lib/net461/OpenMedicus.ServiceStack.Clinic.ServiceModel.dll $RPM_BUILD_ROOT%{mingw64_prefix}%{libdir}
...
%defattr(-,root,root,-)
%{mingw32_prefix}%{libdir}/OpenMedicus.ServiceStack.Clinic.ServiceModel.dll
%{mingw32_datadir}/pkgconfig/OpenMedicus.ServiceStack.Clinic.ServiceModel.pc

%files -n mingw64-%{mingw_pkg_name}
%defattr(-,root,root,-)
%{mingw64_prefix}%{libdir}/OpenMedicus.ServiceStack.Clinic.ServiceModel.dll
