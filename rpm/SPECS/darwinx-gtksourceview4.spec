...
%build
%darwinx_meson -Dgtk_doc=false -Dinstall_tests=false -Dgir=false -Dglade_catalog=false -Dvapi=false
%darwinx_meson_build
...
%files
%{_darwinx_libdir}/libgtksourceview-4.dylib
%{_darwinx_libdir}/libgtksourceview-4.0.dylib
%{_darwinx_datadir}/gtksourceview-4/
%{_darwinx_libdir}/pkgconfig/*.pc
%dir %{_darwinx_includedir}/gtksourceview-4
%{_darwinx_includedir}/gtksourceview-4/*
